...
import dev.filesystemsim.demo.features.homeDirectory.HomeDirectoryRepository;
...
import dev.filesystemsim.demo.features.homeDirectory.mapper.HomeDirectoryMapper;
...
public class HomeDirectoryServiceImpl implements HomeDirectoryService {
    ...
    public HomeDirectoryDto update(Integer id, HomeDirectoryDto directoryDto) {
        ...
        HomeDirectoryEntity savedHomeDirectoryEntity = homeDirectoryRepository.findById(id).map(existingHomeDirectory -> {
                ...
                Optional.ofNullable(homeDirectoryEntity.getContent()).ifPresent(existingHomeDirectory::setContent);
