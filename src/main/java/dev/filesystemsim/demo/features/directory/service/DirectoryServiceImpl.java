...
import dev.filesystemsim.demo.features.directory.mapper.DirectoryMapper;
...
public class DirectoryServiceImpl implements DirectoryService {
    ...
    public DirectoryDto update(Integer id, DirectoryDto directoryDto) {
        ...
        DirectoryEntity savedDirectoryEntity = directoryRepository.findById(id).map(existingDirectory -> {
                ...
                Optional.ofNullable(directoryEntity.getContent()).ifPresent(existingDirectory::setContent);
